let materials = [
    { name: '1 1/2 JALLI', rate: 4300, unit: 'unit', image: 'jalli-1-5.jpg' },
    { name: '3/4 JALLI', rate: 4400, unit: 'unit', image: 'jalli-3-4.jpg' },
    { name: 'P-SAND', rate: 6300, unit: 'unit', image: 'p-sand.jpg' },
    { name: 'M-SAND', rate: 5300, unit: 'unit', image: 'm-sand.jpg' },
    { name: 'RED BRICKS', rate: 10, unit: 'piece', image: 'red-bricks.jpg' },
    { name: 'CEMENT', rate: 300, unit: 'bag', image: 'cement.jpg' },
    { name: 'AAC BLOCKS -4 INCH', rate: 54, unit: 'piece', image: 'aac-blocks.jpg' },
    { name: 'AAC BLOCKS -6 INCH', rate: 78, unit: 'piece', image: 'aac-blocks.jpg' },
    { name: 'AAC BLOCKS -9 INCH', rate: 115, unit: 'piece', image: 'aac-blocks.jpg' }
];
